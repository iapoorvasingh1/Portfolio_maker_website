...
def upload():
    ...
    return render_template(design_name,dname = name,dlname = lastname,dsch = school,img = img_new_name, dcol = college,dph = phone,demail = email,ds1 = skill1,ds2 = skill2,ds3 =skill3,ds4 = skill4,dabout = about)
...
if __name__ == "__main__":
    schedule.every().day.at("22:59").do(delete)
    app.run(debug=True)